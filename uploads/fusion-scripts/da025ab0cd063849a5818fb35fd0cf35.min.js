...
! function(e, t, n, o) {
    var r = [],
        ...
        i = function() {};
    i.prototype = a, i = new i;
    var s = [];

    function c(e, t) {
        return typeof e === t
    }
    var l, d, u = n.documentElement,
        p = "svg" === u.nodeName.toLowerCase();

    function f(e) {
        var t = u.className,
            n = i._config.classPrefix || "";
        if (p && (t = t.baseVal), i._config.enableJSClass) {
            var o = new RegExp("(^|\\s)" + n + "no-js(\\s|$)");
            t = t.replace(o, "$1" + n + "js$2")
        }
        i._config.enableClasses && (e.length > 0 && (t += " " + n + e.join(" " + n)), p ? u.className.baseVal = t : u.className = t)
    }

    function m(e, t) {
        if ("object" == typeof e)
            for (var n in e) l(e, n) && m(n, e[n]);
        else {
            var o = (e = e.toLowerCase()).split("."),
                r = i[o[0]];
            if (2 === o.length && (r = r[o[1]]), void 0 !== r) return i;
            t = "function" == typeof t ? t() : t, 1 === o.length ? i[o[0]] = t : (!i[o[0]] || i[o[0]] instanceof Boolean || (i[o[0]] = new Boolean(i[o[0]])), i[o[0]][o[1]] = t), f([(t && !1 !== t ? "" : "no-") + o.join("-")]), i._trigger(e, t)
        }
        return i
    }
    ...
    var v = function(e) {
        ...
        if (!e) return !1;
        if ((n = (e = e.replace(/^@/, "")).replace(/-/g, "_").toUpperCase() + "_RULE") in a) return "@" + e;
        for (var i = 0; i < r; i++) {
            var s = O[i];
    ...
    var T = function() {
        ...
        return function(t, n) {
            var r;
            return !!t && (n && "string" != typeof n || (n = y(n || "div")), !(r = (t = "on" + t) in n) && e && (n.setAttribute || (n = y("div")), n.setAttribute(t, ""), r = "function" == typeof n[t], n[t] !== o && (n[t] = o), n.removeAttribute(t)), r)
        }
    }();
    a.hasEvent = T, p || function(e, t) {
        var n, o, r = e.html5 || {},
        ...
        function p(e) {
            var t = l[e[s]];
            return t || (t = {}, c++, e[s] = c, l[c] = t), t
        }

        function f(e, n, r) {
            return n || (n = t), o ? n.createElement(e) : (r || (r = p(n)), !(s = r.cache[e] ? r.cache[e].cloneNode() : i.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)).canHaveChildren || a.test(e) || s.tagUrn ? s : r.frag.appendChild(s));
            var s
        }
        ...
        function m(e) {
            e || (e = t);
            var r = p(e);
            return !h.shivCSS || n || r.hasCSS || (r.hasCSS = !!d(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), o || function(e, t) {
            ...
            try {
                ...
                e.innerHTML = "<xyz></xyz>", n = "hidden" in e, o = 1 == e.childNodes.length || function() {
                    t.createElement("a");
        ...
        var h = {
            ...
            createDocumentFragment: function(e, n) {
                ...
                for (var r = (n = n || p(e)).frag.cloneNode(), a = 0, i = u(), s = i.length; a < s; a++) r.createElement(i[a]);
                return r
            },
        ...
        var v, g = /^$|\b(?:all|print)\b/,
            y = "html5shiv",
            T = !(o || (v = t.documentElement, void 0 === t.namespaces || void 0 === t.parentWindow || void 0 === v.applyElement || void 0 === v.removeNode || void 0 === e.attachEvent));
        ...
        function x(e) {
            var t, n, o = p(e),
                r = e.namespaces,
                a = e.parentWindow;
            if (!T || e.printShived) return e;

            function i() {
                clearTimeout(o._removeSheetTimer), t && t.removeNode(!0), t = null
            }
            return void 0 === r[y] && r.add(y), a.attachEvent("onbeforeprint", function() {
                i();
                for (var o, r, a, s = e.styleSheets, c = [], l = s.length, p = Array(l); l--;) p[l] = s[l];
                for (; a = p.pop();)
                    if (!a.disabled && g.test(a.media)) {
                        ...
                        for (l = 0; l < r; l++) p.push(o[l]);
                        try {
                            c.push(a.cssText)
                        } catch (e) {}
                    }
                c = function(e) {
                    for (var t, n = e.split("{"), o = n.length, r = RegExp("(^|[\\s,>+~])(" + u().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), a = "$1" + y + "\\:$2"; o--;)(t = n[o] = n[o].split("}"))[t.length - 1] = t[t.length - 1].replace(r, a), n[o] = t.join("}");
                    return n.join("{")
                }(c.reverse().join("")), n = function(e) {
                    for (var t, n = e.getElementsByTagName("*"), o = n.length, r = RegExp("^(?:" + u().join("|") + ")$", "i"), a = []; o--;) t = n[o], r.test(t.nodeName) && a.push(t.applyElement(b(t)));
                    return a
                }(e), t = d(e, c)
            }), a.attachEvent("onafterprint", function() {
                ! function(e) {
                    for (var t = e.length; t--;) e[t].removeNode()
                }(n), clearTimeout(o._removeSheetTimer), o._removeSheetTimer = setTimeout(i, 500)
            }), e.printShived = !0, e
        }
        h.type += " print", h.shivPrint = x, x(t), "object" == typeof module && module.exports && (module.exports = h)
    }(void 0 !== t ? t : this, n);
    var b = function() {},
        x = function() {};

    function w(e, t, o, r) {
        var a, i, s, c, l = "modernizr",
            d = y("div"),
            f = function() {
                var e = n.body;
                return e || ((e = y(p ? "svg" : "body")).fake = !0), e
            }();
        if (parseInt(o, 10))
            for (; o--;)(s = y("div")).id = r ? r[o] : l + (o + 1), d.appendChild(s);
        return (a = y("style")).type = "text/css", a.id = "s" + l, (f.fake ? f : d).appendChild(a), f.appendChild(d), a.styleSheet ? a.styleSheet.cssText = e : a.appendChild(n.createTextNode(e)), d.id = l, f.fake && (f.style.background = "", f.style.overflow = "hidden", c = u.style.overflow, u.style.overflow = "hidden", u.appendChild(f)), i = t(d, e), f.fake && f.parentNode ? (f.parentNode.removeChild(f), u.style.overflow = c, u.offsetHeight) : d.parentNode.removeChild(d), !!i
    }
    ...
    function S(e, n, o) {
        ...
        if ("getComputedStyle" in t) {
            ...
            else if (a) a[a.error ? "error" : "log"].call(a, "getComputedStyle returning null, its possible modernizr test results are inaccurate")
        } else r = !n && e.currentStyle && e.currentStyle[o];
        return r
    }
    t.console && (b = function() {
        ...
        "yepnope" in t ? (x("yepnope.js (aka Modernizr.load) is no longer included as part of Modernizr. yepnope appears to be available on the page, so weâ€™ll use it to handle this call to Modernizr.load, but please update your code to use yepnope directly.\n See http://github.com/Modernizr/Modernizr/issues/1182 for more information."), t.yepnope.apply(t, [].slice.call(arguments, 0))) : b("yepnope.js (aka Modernizr.load) is no longer included as part of Modernizr. Get it from http://yepnopejs.com. See http://github.com/Modernizr/Modernizr/issues/1182 for more information.")
    };
    ...
    function M(e, n, r, a) {
        if (a = !c(a, "undefined") && a, !c(r, "undefined")) {
            var i = function(e, n) {
                var r = e.length;
                if ("CSS" in t && "supports" in t.CSS) {
                    for (; r--;)
                        if (t.CSS.supports(z(e[r]), n)) return !0;
                    return !1
                }
                if ("CSSSupportsRule" in t) {
                    for (var a = []; r--;) a.push("(" + z(e[r]) + ":" + n + ")");
            ...
            if (!c(i, "undefined")) return i
        }
        for (var s, l, d, u, p, f = ["modernizr", "tspan", "samp"]; !_.style && f.length;) s = !0, _.modElem = y(f.shift()), _.style = _.modElem.style;

        function m() {
            s && (delete _.style, delete _.modElem)
        }
        for (d = e.length, l = 0; l < d; l++)
            if (u = e[l], p = _.style[u], P(u, "-") && (u = N(u)), _.style[u] !== o) {
                if (a || c(r, "undefined")) return m(), "pfx" !== n || u;
                try {
                    _.style[u] = r
                } catch (e) {}
                if (_.style[u] !== p) return m(), "pfx" !== n || u
            }
        return m(), !1
    }
    ...
    function j(e, t, n, o, r) {
        ...
        return c(t, "string") || c(t, "undefined") ? M(i, t, o, r) : function(e, t, n) {
            var o;
            for (var r in e)
                if (e[r] in t) return !1 === n ? e[r] : c(o = t[e[r]], "function") ? $(o, n || t) : o;
            return !1
    ...
    var A = a.prefixed = function(e, t, n) {
            return 0 === e.indexOf("@") ? v(e) : (-1 !== e.indexOf("-") && (e = N(e)), t ? j(e, t, n) : j(e, "pfx"))
        },
    ...
    i.addTest("touchevents", function() {
        ...
        function() {
            ...
            try {
                e.canPlayType && (i.addTest("audio.ogg", e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "")), i.addTest("audio.mp3", e.canPlayType('audio/mpeg; codecs="mp3"').replace(/^no$/, "")), i.addTest("audio.opus", e.canPlayType('audio/ogg; codecs="opus"') || e.canPlayType('audio/webm; codecs="opus"').replace(/^no$/, "")), i.addTest("audio.wav", e.canPlayType('audio/wav; codecs="1"').replace(/^no$/, "")), i.addTest("audio.m4a", (e.canPlayType("audio/x-m4a;") || e.canPlayType("audio/aac;")).replace(/^no$/, "")))
            } catch (e) {}
        ...
        }), i.addTest("geolocation", "geolocation" in navigator), i.addTest("history", function() {
    ...
    var D = y("input"),
        ...
        W = {};
    i.input = function(e) {
            for (var n = 0, o = e.length; n < o; n++) W[e[n]] = !!(e[n] in D);
            return W.list && (W.list = !(!y("datalist") || !t.HTMLDataListElement)), W
        }(F),
        function() {
            for (var e, t, r, a = ["search", "tel", "url", "email", "datetime", "date", "month", "week", "time", "datetime-local", "number", "range", "color"], s = 0; s < a.length; s++) D.setAttribute("type", e = a[s]), (r = "text" !== D.type && "style" in D) && (D.value = "1)", D.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(e) && D.style.WebkitAppearance !== o ? (u.appendChild(D), r = (t = n.defaultView).getComputedStyle && "textfield" !== t.getComputedStyle(D, null).WebkitAppearance && 0 !== D.offsetHeight, u.removeChild(D)) : /^(search|tel)$/.test(e) || (r = /^(url|email)$/.test(e) ? D.checkValidity && !1 === D.checkValidity() : "1)" !== D.value)), i.addTest("inputtypes." + e, !!r)
        }();
    var q = !0;
    try {
        t.postMessage({
    ...
    i.addTest("postmessage", new Boolean("postMessage" in t)), i.addTest("postmessage.structuredclones", q),
        function() {
            var e = y("video");
            ...
            try {
                e.canPlayType && (i.addTest("video.ogg", e.canPlayType('video/ogg; codecs="theora"').replace(/^no$/, "")), i.addTest("video.h264", e.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(/^no$/, "")), i.addTest("video.h265", e.canPlayType('video/mp4; codecs="hev1"').replace(/^no$/, "")), i.addTest("video.webm", e.canPlayType('video/webm; codecs="vp8, vorbis"').replace(/^no$/, "")), i.addTest("video.vp9", e.canPlayType('video/webm; codecs="vp9"').replace(/^no$/, "")), i.addTest("video.hls", e.canPlayType('application/x-mpegURL; codecs="avc1.42E01E"').replace(/^no$/, "")), i.addTest("video.av1", e.canPlayType('video/mp4; codecs="av01"').replace(/^no$/, "")))
            } catch (e) {}
    ...
    i.addTest("websockets", H), i.addTest("cssanimations", R("animationName", "a", !0)), i.addTest("backgroundsize", R("backgroundSize", "100%", !0)), i.addTest("borderimage", R("borderImage", "url() 1", !0)), i.addTest("borderradius", R("borderRadius", "0px", !0)), i.addTest("boxshadow", R("boxShadow", "1px 1px", !0)), i.addTest("flexbox", R("flexBasis", "1px", !0)), (I = navigator.userAgent, V = I.match(/w(eb)?osbrowser/gi), U = I.match(/windows phone/gi) && I.match(/iemobile\/([0-9])+/gi) && parseFloat(RegExp.$1) >= 9, V || U) ? i.addTest("fontface", !1) : B('@font-face {font-family:"font";src:url("https://")}', function(e, t) {
        ...
        for (var e, t = "background-image:", n = "", o = 0, r = O.length - 1; o < r; o++) e = 0 === o ? "to " : "", n += t + O[o] + "linear-gradient(" + e + "left top, #9f9, white);";
    ...
    }), i.addTest("cssreflections", R("boxReflect", "above", !0)), i.addTest("rgba", function() {
        var e = y("a").style;
        return e.cssText = "background-color:rgba(150,255,150,.5)", ("" + e.backgroundColor).indexOf("rgba") > -1
    }), i.addTest("textshadow", L("textShadow", "1px 1px")), i.addTest("csstransforms", function() {
        return -1 === navigator.userAgent.indexOf("Android 2.") && R("transform", "scale(1)", !0)
    });
    var G = "CSS" in t && "supports" in t.CSS,
        J = "supportsCSS" in t;
    i.addTest("supports", G || J), i.addTest("csstransforms3d", function() {
        return !!R("perspective", "1px", !0)
    }), i.addTest("csstransitions", R("transition", "all", !0)), i.addTest("localstorage", function() {
        var e = "modernizr";
        try {
        ...
        function() {
            ...
            for (var d in r)
                if (r.hasOwnProperty(d)) {
                    if (e = [], (t = r[d]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
                        for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
                    for (o = c(t.fn, "function") ? t.fn() : t.fn, a = 0; a < e.length; a++) 1 === (l = e[a].split(".")).length ? i[l[0]] = o : (i[l[0]] && (!i[l[0]] || i[l[0]] instanceof Boolean) || (i[l[0]] = new Boolean(i[l[0]])), i[l[0]][l[1]] = o), s.push((o ? "" : "no-") + l.join("-"))
                }
        }(), f(s), delete a.addTest, delete a.addAsyncTest;
    for (var K = 0; K < i._q.length; K++) i._q[K]();
    e.Modernizr = i
...
function fusionSetAnimationData(i) {
    "off" === fusionAnimationsVars.status_css_animations || cssua.ua.mobile && "desktop_and_mobile" !== fusionAnimationsVars.status_css_animations ? jQuery("body").addClass("dont-animate").removeClass("do-animate") : (jQuery("body").addClass("do-animate").removeClass("dont-animate"), void 0 !== i && void 0 !== i.data.custom && jQuery(window).initElementAnimations())
}! function(i) {
    "use strict";
    window.awbAnimationObservers = {}, i.fn.initElementAnimations = function() {
            ...
            var t = fusion.getAnimationIntersectionData(n),
                e = new IntersectionObserver(function(n, a) {
                    i.each(n, function(n, a) {
                        var o, s, u, r, d, m = i(a.target),
                            c = 0;
                        a.isIntersecting && (d = !0, 0 !== t.threshold && (i(window).height() < m.outerHeight() ? i(window).height() / m.outerHeight() > a.intersectionRatio && (d = !1) : 1 > a.intersectionRatio && (d = !1)), d && (m.parents(".fusion-delayed-animation").length || (m.css("visibility", "visible"), o = m.data("animationtype"), s = m.data("animationduration"), u = m.data("animationdelay"), m.addClass(o), s && (m.css("animation-duration", s + "s"), c += 1e3 * s), u && (m.css("animation-delay", u + "s"), c += 1e3 * u), c && (r = m, setTimeout(function() {
                            r.removeClass(o)
                        }, c))), e.unobserve(a.target)))
                    })
                }, t);
...
jQuery(document).ready(function() {
    jQuery(".fusion-vertical-menu-widget .current_page_item, .fusion-vertical-menu-widget .current-menu-item").each(function() {
        var e = jQuery(this),
            n = e.parent();
        e.find(".children, .sub-menu").length && e.find(".children, .sub-menu").show("slow"), e.parentsUntil(".fusion-vertical-menu-widget", ".children, .sub-menu").show("slow"), n.hasClass("fusion-vertical-menu-widget") && e.find("ul").show("slow")
    })
}), jQuery(window).on("load", function() {
    jQuery(".fusion-vertical-menu-widget.click li a .arrow").on("click", function(e) {
        ...
        jQuery(this).hover(function() {
            ...
            clearTimeout(e), e = setTimeout(function() {
                0 === n.find(".current_page_item").length && !1 === n.hasClass("current_page_item") && i.stop(!0, !0).slideUp("slow")
            }, 500)
        })
    })
});
...
var fusion = {
    ...
    restArguments: function(t, e) {
        return e = null == e ? t.length - 1 : +e,
            function() {
                for (var n, i = Math.max(arguments.length - e, 0), o = Array(i), r = 0; r < i; r++) o[r] = arguments[r + e];
                switch (e) {
                    case 0:
                ...
                for (n = Array(e + 1), r = 0; r < e; r++) n[r] = arguments[r];
    ...
    debounce: function(t, e, n) {
        ...
        return r = function(e, n) {
            ...
            return i && clearTimeout(i), n ? (u = !i, i = setTimeout(r, e), u && (o = t.apply(this, s))) : i = a.delay(r, e, this, s), o
        })).cancel = function() {
    ...
    getHeight: function(t, e) {
        var n = 0;
        return "number" == typeof t ? n = t : "string" == typeof t && (t.includes(".") || t.includes("#")) ? (e = void 0 !== e && e, jQuery(t).each(function() {
    ...
    getObserverSegmentation: function(t) {
        ...
        return t.each(function() {
            ...
            n.length || delete e[t]
        }), 0 === Object.keys(e).length && (e["top-into-view"] = t), e
    },
    getAnimationIntersectionData: function(t) {
        var e = "",
            n = 0,
            i = "0px 0px 0px 0px";
        return "string" == typeof t ? e = t : void 0 !== t.data("animationoffset") && (e = t.data("animationoffset")), "top-mid-of-view" === e ? i = "0px 0px -50% 0px" : "bottom-in-view" === e && (n = [0, .2, .4, .6, .7, .8, .9, 1]), {
            root: null,
            rootMargin: i,
            threshold: n
        }
    ...
    shouldObserverEntryAnimate: function(t, e) {
        var n = !1,
            i = 1;
        return 1 < e.thresholds.length ? t.boundingClientRect.height > t.rootBounds.height ? (i = t.rootBounds.height / t.boundingClientRect.height, e.thresholds.filter(function(e) {
            return e >= t.intersectionRatio && e <= i
        }).length || (n = !0)) : t.isIntersecting && 1 === t.intersectionRatio && (n = !0) : t.isIntersecting && (n = !0), n
    },
    getCurrentPostID: function() {
        return null === this.currentPostID && (this.currentPostID = void 0 !== jQuery("body").data("awb-post-id") ? jQuery("body").data("awb-post-id") : 0), this.currentPostID
    }
};
fusion.delay = fusion.restArguments(function(t, e, n) {
    ...
    }) : "string" == typeof t && (e = document.querySelectorAll(t), e = Array.prototype.slice.call(e)), e) : []
    ...
    var t;
    void 0 === jQuery.migrateVersion && 2 < parseInt(jQuery.fn.jquery) && jQuery(window.document).triggerHandler("ready"), t = fusion.debounce(function() {
    ...
    }, 250), fusion.fusionResizeWidth = jQuery(window).width(), fusion.fusionResizeHeight = jQuery(window).height(), jQuery(window).on("resize", t)
});
! function(n) {
    "use strict";
        ...
        e.data(a, "flexslider", i), h = {
            ...
            touch: function() {
                ...
                if (o) {} else c = function(r) {
                    i.animating ? r.preventDefault() : (window.navigator.msPointerEnabled || 1 === r.touches.length) && (i.pause(), s = u ? i.h : i.w, l = Number(new Date), g = r.touches[0].pageX, y = r.touches[0].pageY, n = p && v && i.animatingTo === i.last ? 0 : p && v ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : p && i.currentSlide === i.last ? i.limit : p ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : v ? (i.last - i.currentSlide + i.cloneOffset) * s : (i.currentSlide + i.cloneOffset) * s, e = u ? y : g, t = u ? g : y, a.addEventListener("touchmove", d, !1), a.addEventListener("touchend", f, !1))
                }, d = function(a) {
                    g = a.touches[0].pageX, y = a.touches[0].pageY, r = u ? e - y : (i.vars.rtl ? -1 : 1) * (e - g);
                    (!(h = u ? Math.abs(r) < Math.abs(g - t) : Math.abs(r) < Math.abs(y - t)) || Number(new Date) - l > 500) && (a.preventDefault(), !m && i.transitions && (i.vars.animationLoop || (r /= 0 === i.currentSlide && r < 0 || i.currentSlide === i.last && r > 0 ? Math.abs(r) / s + 2 : 1), i.setProps(n + r, "setTouch")))
                }, f = function(o) {
            ...
            i.transitions && (s = u ? "translate3d(0," + s + ",0)" : "translate3d(" + parseInt(s) + "px,0,0)", a = void 0 !== a ? a / 1e3 + "s" : "0s", i.container.css("-" + i.pfx + "-transition-duration", a), i.container.css("transition-duration", a)), i.args[i.prop] = s, (i.transitions || void 0 === a) && i.container.css(i.args), i.container.css("transform", s)
        }, i.setup = function(t) {
            var a, n;
            m ? (i.vars.rtl ? i.slides.css({
                ...
                i.is(":visible") && i.doMath(), i.vars.rtl ? i.newSlides.css({
                    width: i.computedW,
...
! function($, window, undefined) {
    ...
    function getTypeByExtension(e, t) {
        ...
        if (o = -1 !== extensions.image.indexOf(i) ? "image" : -1 !== extensions.flash.indexOf(i) ? "flash" : -1 !== extensions.video.indexOf(i) ? "video" : "iframe", t) {
    ...
    iLightBox.prototype = {
            ...
            loadSwitcher: function(e, t, o, i) {
                ...
                switch (e.type) {
                    ...
                    case "iframe":
                        ...
                        "function" == typeof a.callback.onRender && a.callback.onRender.call(n, n.ui, o), "function" == typeof e.options.onRender && e.options.onRender.call(n, r), "function" == typeof a.callback.onBeforeLoad && a.callback.onBeforeLoad.call(n, n.ui, o), "function" == typeof e.options.onBeforeLoad && e.options.onBeforeLoad.call(n, r), n.configureHolder(e, i, t);
                        var d = !1;
                        h.on("load", function() {
                            "function" == typeof a.callback.onAfterLoad && a.callback.onAfterLoad.call(n, n.ui, o), "function" == typeof e.options.onAfterLoad && e.options.onAfterLoad.call(n, r), d = !0, n.hideLoader(), h.off("load")
                        }), setTimeout(function() {
                    ...
                    case "inline":
                        ...
                        }), p.children().eq(0).show(), "function" == typeof a.callback.onRender && a.callback.onRender.call(n, n.ui, o), "function" == typeof e.options.onRender && e.options.onRender.call(n, r), "function" == typeof a.callback.onBeforeLoad && a.callback.onBeforeLoad.call(n, n.ui, o), "function" == typeof e.options.onBeforeLoad && e.options.onBeforeLoad.call(n, r), n.loadImage(f, function() {
                    ...
                    case "ajax":
                        ...
                        "function" == typeof a.callback.onBeforeLoad && a.callback.onBeforeLoad.call(n, n.ui, o), "function" == typeof e.options.onBeforeLoad && e.options.onBeforeLoad.call(n, r), n.showLoader(), $.ajax({
                            ...
                            h.empty().append($('<div class="ilightbox-wrapper"></div>').css(f).html(u)), t.show().data({
                    ...
                    case "html":
                        ...
                        f = findImageInElement(t);
                        "function" == typeof a.callback.onBeforeLoad && a.callback.onBeforeLoad.call(n, n.ui, o), "function" == typeof e.options.onBeforeLoad && e.options.onBeforeLoad.call(n, r), n.loadImage(f, function() {
            ...
            hashChangeHandler: function(e) {
                ...
                if (!(o.hashLock || "#" + i.linkId != a[0].replace("%5B", "[").replace("%5D", "]") && n.length > 1))
                    if (r) {
                        var s = a[1] || 0;
                        if (t.items[s])(l = $(".ilightbox-overlay")).length && l.attr("linkid") == i.linkId ? t.goTo(s) : t.itemsObject[s].trigger(supportTouch ? "itap" : "click");
    ...
    var PluginDetect = {
        ...
        initScript: function() {
            ...
            if (e.head = o.getElementsByTagName("head")[0] || o.getElementsByTagName("body")[0] || o.body || null, e.isIE = !1, e.verIE = e.isIE && /MSIE\s*(\d+\.?\d*)/i.test(i) ? parseFloat(RegExp.$1, 10) : null, e.verIEfull = null, e.docModeIE = null, e.isIE) {
...
function _fusionRefreshWindow() {
    ...
    function(t, i) {
        ...
        function a(i, a) {
            var n;
            this.element = i, this.settings = t.extend({}, s, a), n = this.settings.align.split(" "), this.settings.xpos = n[0], 2 === n.length ? this.settings.ypos = n[1] : this.settings.ypos = "center", this._defaults = s, this._name = e, this.init()
        }
        t.extend(a.prototype, {
            ...
            setBackgroundStyling: function(t, i) {
                ...
                this.settings.backgroundColorMedium && Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_medium + "px)") && (s = this.settings.backgroundColorMedium), this.settings.backgroundColorSmall && Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_small + "px)") && (s = this.settings.backgroundColorSmall), this.settings.blendModeMedium && Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_medium + "px)") && (e = this.settings.blendModeMedium), this.settings.blendModeSmall && Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_small + "px)") && (e = this.settings.blendModeSmall), t.find(".parallax-inner").css({
                    "background-color": s,
            ...
            resizeParallaxBackground: function() {
                var t, e, s, a, n, o, r, d, g, l, h, u, c = this.settings.target,
                    m = "";
                void 0 !== c && 0 !== c.length && c.is(":visible") && (u = c.hasClass("lazyload"), t = "true" === this.settings.repeat || !0 === this.settings.repeat || 1 === this.settings.repeat, "" === this.settings.gradientStartColor && "" === this.settings.gradientStartPosition || ("linear" === this.settings.gradientType ? m += "linear-gradient(" + this.settings.gradientAngle + "deg, " : "radial" === this.settings.gradientType && (m += "radial-gradient(circle at " + this.settings.gradientRadialDirection + ", "), m += this.settings.gradientStartColor + " " + this.settings.gradientStartPosition + "%,", m += this.settings.gradientEndColor + " " + this.settings.gradientEndPosition + "%)", "" !== this.settings.image && "none" !== this.settings.image && (m += ",url('" + this.settings.image + "')")), "none" === this.settings.direction ? (e = c.width() + parseInt(c.css("paddingRight"), 10) + parseInt(c.css("paddingLeft"), 10), a = c.offset().left, "center" === this.settings.align ? a = "50% 50%" : "left" === this.settings.align ? a = "0% 50%" : "right" === this.settings.align ? a = "100% 50%" : "top" === this.settings.align ? a = "50% 0%" : "bottom" === this.settings.align && (a = "50% 100%"), c.css({
                ...
                }), "" !== this.settings.image && "none" !== this.settings.image && c.attr("style", "background-image: url(" + this.settings.image + ") !important;" + c.attr("style"))) : "left" === this.settings.direction || "right" === this.settings.direction ? (e = c.width() + parseInt(c.css("paddingRight"), 10) + parseInt(c.css("paddingLeft"), 10), s = c.height() + 4 + parseInt(c.css("paddingTop"), 10) + parseInt(c.css("paddingBottom"), 10), n = e, e += 400 * Math.abs(parseFloat(this.settings.velocity)), o = 0, "right" === this.settings.direction && (o -= e - n), 1 > c.find(".parallax-inner").length && c.prepend('<div class="parallax-inner"></div>'), c.css({
                    position: "relative",
                    overflow: "hidden",
                    zIndex: 1,
                    ...
                    opacity: Math.abs(parseFloat(this.settings.opacity) / 100),
                    backgroundImage: u ? "" : "url(" + this.settings.image + ")"
                }), this.setBackgroundStyling(c, m)), d = 0, c.offset().top > i._fusionWindowHeight && (d = c.offset().top - i._fusionWindowHeight), g = c.offset().top + c.height() + parseInt(c.css("paddingTop"), 10) + parseInt(c.css("paddingBottom"), 10), this.moveMax = e - n, this.scrollTopMin = d, this.scrollTopMax = g) : (r = 900, r = jQuery(i).height(), e = c.width() + parseInt(c.css("paddingRight"), 10) + parseInt(c.css("paddingLeft"), 10), l = s = c.height() + parseInt(c.css("paddingTop"), 10) + parseInt(c.css("paddingBottom"), 10), s += r * Math.abs(parseFloat(this.settings.velocity)), h = 0, "down" === this.settings.direction && (h -= s - l), 1 > c.find(".parallax-inner").length && c.prepend('<div class="parallax-inner"></div>'), c.css({
                    position: "relative",
                    overflow: "hidden",
                    zIndex: 1,
                    "background-image": "none"
                    ...
                    opacity: Math.abs(parseFloat(this.settings.opacity) / 100),
                    backgroundImage: u ? "" : "url(" + this.settings.image + ")"
                }), this.setBackgroundStyling(c, m)), d = 0, c.offset().top > i._fusionWindowHeight && (d = c.offset().top - i._fusionWindowHeight), g = c.offset().top + c.height() + parseInt(c.css("paddingTop"), 10) + parseInt(c.css("paddingBottom"), 10), this.moveMax = s - l, this.scrollTopMin = d, this.scrollTopMax = g), u && c.find(".parallax-inner").attr("data-bg", this.settings.image).addClass("lazyload"))
            },
            isMobile: function() {
...
(function() {
    ...
    t = this.jQuery || window.jQuery, i = t(window), t.fn.stick_in_parent = function(s) {
        ...
        for (null == s && (s = {}), k = s.sticky_class, a = s.inner_scrolling, d = s.recalc_every, g = s.parent, u = s.offset_top, l = s.spacer, e = s.bottoming, h = void 0 !== s.transition_offset && parseFloat(s.transition_offset), p = void 0 !== s.observer && s.observer, y = void 0 !== s.scroll_transition && parseFloat(s.scroll_transition), v = void 0 !== s.clone && s.clone, m = !1, adminBarHeight = fusion.getAdminbarHeight(), null == u && (u = 0), "fusion-container-stuck" === k && "object" == typeof fusion && "function" == typeof fusion.getHeight && (u = fusion.getHeight(u) + adminBarHeight), null == g && (g = void 0), null == a && (a = !0), null == k && (k = "is_stuck"), o = t(document), null == e && (e = !0), r = function(n, r, c, f, w, x, j, H) {
                var z, I, A, O, Q, B, F, M, R, T, D, G, S;
                if (!n.data("sticky_kit")) {
                    if (n.attr("data-sticky_kit", !0), Q = o.height(), F = n.parent(), null != g && (F = F.closest(g)), !F.length) throw "failed to find stick parent";
                    if (A = !1, z = !1, null != l ? D = l && n.closest(l) : v ? (D = n.clone(!1)).addClass("fusion-sticky-spacer").removeClass("fusion-sticky-transition") : D = jQuery('<div class="fusion-sticky-spacer" />'), D && D.css("position", n.css("position")), overlap = function(t, i) {
                            ...
                            f = i.height, _()
                        }).observe(F[0]), (M = function() {
                            var t, i, s, e, a, g;
                            if (!H) return Q = o.height(), t = parseInt(F.css("border-top-width"), 10), i = parseInt(F.css("padding-top"), 10), r = parseInt(F.css("padding-bottom"), 10), c = F.offset().top + t + i, f = F.height(), A && (A = !1, z = !1, null == l && (n.next(".fusion-sticky-spacer").length ? D = n.next(".fusion-sticky-spacer") : n.insertAfter(D)), n.css({
                                position: "",
                                top: "",
                                width: "",
                                bottom: ""
                            }).removeClass(k), s = !0), a = 0, (g = n.css("transform")).includes("matrix(") && n.hasClass("fusion-sticky-scroll-transition") && void 0 !== (g = g.slice(7, g.length - 1).split(", "))[5] && (a = -parseFloat(g[5])), w = a + n.offset().top - (parseInt(n.css("margin-top"), 10) || 0) - u, x = n.outerHeight(!0), j = n.css("float"), D && (e = {
                                width: n.outerWidth(!0),
                                display: n.css("display"),
                                "vertical-align": n.css("vertical-align"),
                                float: j
                            }, v || (e.height = x), D.css(e)), s ? G() : void 0
                        })(), x !== f) {
                        if (O = void 0, B = u, T = d, G = function() {
                                var t, s, g, v, m, b;
                                if (!H) return g = !1, null != T && 0 >= (T -= 1) && (T = d, M(), g = !0), null == T || g || o.height() === Q || (M(), g = !0), v = i.scrollTop(), null != O && (s = v - O), O = v, A ? (e && (m = v + x + B > f + c, z && !m && (z = !1, n.css({
                                    position: "fixed",
                                    bottom: "",
                                    top: B
                                }).trigger("sticky_kit:unbottom"))), v < w && (A = !1, B = u, null == l && ("left" !== j && "right" !== j || n.insertAfter(D), D && D.detach()), t = {
                                    position: "",
                                    width: "",
                                    top: ""
                                }, n.css(t).removeClass(k).trigger("sticky_kit:unstick"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-change")), a && (b = i.height(), x + u > b && (z || (B -= s, B = Math.max(b - x, B), B = Math.min(u, B), A && n.css({
                                    top: B + "px"
                                }))))) : (v > w || v === w) && (A = !0, (t = {
                                    position: "fixed",
                                    top: B
                                }).width = "border-box" === n.css("box-sizing") ? n.outerWidth() + "px" : n.width() + "px", n.css(t).addClass(k), null == l && (n.after(D), "left" !== j && "right" !== j || D.append(n)), n.trigger("sticky_kit:stick"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-change")), !1 === h || p || (!n.is(".fusion-sticky-transition") && v - w > h ? (n.addClass("fusion-sticky-transition"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-transition-change")) : n.is(".fusion-sticky-transition") && v - w <= h && (n.removeClass("fusion-sticky-transition"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-transition-change"))), !1 !== y && 0 !== y && (0 > s && !window.scrollDisabled ? n.hasClass("fusion-scrolling-up") || (n.addClass("fusion-scrolling-up").removeClass("fusion-scrolling-down"), i.trigger("fusion-sticky-scroll-change")) : n.hasClass("fusion-scrolling-down") || (n.addClass("fusion-scrolling-down").removeClass("fusion-scrolling-up"), i.trigger("fusion-sticky-scroll-change")), !n.is(".fusion-sticky-scroll-transition") && v - w > y ? (n.addClass("fusion-sticky-scroll-transition"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-scroll-change")) : n.is(".fusion-sticky-scroll-transition") && v - w <= y && (n.removeClass("fusion-sticky-scroll-transition"), "fusion-container-stuck" === k && i.trigger("fusion-sticky-scroll-change"))), A && e && (null == m && (m = v + x + B > f + c), !z && m) ? (z = !0, "static" === F.css("position") && F.css({
                                    position: "relative"
                                }), n.css({
                                    position: "absolute",
                                    bottom: r,
                                ...
                                var i;
                                "object" == typeof fusion && "function" == typeof fusion.getHeight && (u = void 0 === s.offset_top ? 0 : s.offset_top, "fusion-container-stuck" === k ? u = fusion.getHeight(u) + adminBarHeight : "fusion-sidebar-stuck" === k && jQuery(".fusion-tb-header").length && "function" == typeof fusionGetStickyOffset && (i = fusionGetStickyOffset()) && (u = i + adminBarHeight + 50), B = u), R(), void 0 !== t && "string" == typeof t.type && "resize" === t.type && "function" == typeof W && W()
                            }, "object" == typeof fusion && "function" == typeof fusion.debounce) var W = fusion.debounce(_, 350);
                        return C = function(t) {
                            m || (m = !0, _(t), W(), setTimeout(function() {
                                m = !1
                            }, 100))
                        }, b = function() {
                            p && S.observe(n.next()[0])
                        }, I = function() {
                            if (H = !0, i.off("touchmove", G), i.off("scroll", G), i.off("resize", _), t(document.body).off("sticky_kit:recalc", R), "fusion-container-stuck" === k && i.trigger("fusion-sticky-change"), n.off("sticky_kit:detach", I), n.removeData("sticky_kit"), n.removeAttr("data-sticky_kit"), n.css({
                                    position: "",
                                    bottom: "",
                                    top: "",
                                    width: ""
                                }), n.removeClass("fusion-sticky-transition"), F.position("position", ""), A) return null == l && ("left" !== j && "right" !== j || n.insertAfter(D), D.remove()), n.removeClass(k);
                            n.next(".fusion-sticky-spacer").length && n.next(".fusion-sticky-spacer").remove()
                        }, D && D.detach(), "fusion-sidebar-stuck" === k && jQuery(".fusion-tb-header").length && i.on("fusion-sticky-change fusion-sticky-scroll-change fusion-sticky-transition-change", C), i.on("touchmove", G), i.on("scroll", G), i.on("resize", _), t(document.body).on("sticky_kit:recalc", R), n.on("sticky_kit:detach", I), n.on("sticky_kit:stick", b), setTimeout(G, 0)
                    }
                }
...
! function(t, e) {
    var a = function(t, e, a) {
        ...
        if (function() {
                ...
                for (e in n = t.lazySizesConfig || t.lazysizesConfig || {}, a) e in n || (n[e] = a[e])
        ...
        var r = e.documentElement,
            ...
            b = function(t, a, n, r, s) {
                ...
                return n || (n = {}), n.instance = i, o.initEvent(a, !r, !s), o.detail = n, t.dispatchEvent(o), o
            },
            p = function(e, a) {
                var i;
                !s && (i = t.picturefill || n.pf) ? (a && a.src && !e.getAttribute("srcset") && e.setAttribute("srcset", a.src), i({
                    reevaluate: !0,
                    elements: [e]
                })) : a && a.src && (e.src = a.src)
            },
            ...
            E = (F = [], R = [], D = F, j = function() {
                var t = D;
                for (D = F.length ? R : F, T = !0, k = !1; t.length;) t.shift()();
                T = !1
            }, q = function(t, a) {
                T && !a ? t.apply(this, arguments) : (D.push(t), k || (k = !0, (e.hidden ? l : d)(j)))
            }, q._lsFlush = j, q),
            _ = function(t, e) {
                return e ? function() {
                    E(t)
            ...
            L = function() {
                var s, f, g, C, L, N, x, W, B, S, T, k, F, R, D, j, q, H, I, O = /^img$/i,
                    P = /^iframe$/i,
                    ...
                    G = function(t) {
                        return null == k && (k = "hidden" == A(e.body, "visibility")), k || !("hidden" == A(t.parentNode, "visibility") && "hidden" == A(t, "visibility"))
                    },
                    K = function(t, a) {
                        var i, n = t,
                            s = G(t);
                        for (W -= a, T += a, B -= a, S += a; s && (n = n.offsetParent) && n != e.body && n != r;)(s = (A(n, "opacity") || 1) > 0) && "visible" != A(n, "overflow") && (i = n.getBoundingClientRect(), s = S > i.left && B < i.right && T > i.top - 1 && W < i.bottom + 1);
                        return s
                    },
                    X = function() {
                        ...
                        if ((C = n.loadMode) && V < 8 && (t = h.length)) {
                            for (a = 0, J++; a < t; a++)
                                if (h[a] && !h[a]._lazyRace)
                                    if (!$ || i.prematureUnveil && i.prematureUnveil(h[a])) nt(h[a]);
                                ...
                                if (nt(h[a]), d = !0, V > 9) break
                            } else !d && f && !l && V < 4 && J < 4 && C > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || !g && (T || S || B || W || "auto" != h[a].getAttribute(n.sizesAttr))) && (l = s[0] || h[a]);
                            l && !d && nt(l)
                        }
                    },
                    Y = (F = X, D = 0, j = n.throttleDelay, q = n.ricTimeout, H = function() {
                        R = !1, D = a.now(), F()
                    }, I = u && q > 49 ? function() {
                        u(H, {
                            timeout: q
                        ...
                        var e;
                        (t = !0 === t) && (q = 33), R || (R = !0, (e = j - (a.now() - D)) < 0 && (e = 0), t || e < 9 ? I() : l(I, e))
                    }),
                    Z = function(t) {
                        var e = t.target;
                        e._lazyCache ? delete e._lazyCache : (U(t), v(e, n.loadedClass), z(e, n.loadingClass), h(e, et), b(e, "lazyloaded"))
                    },
                    tt = _(Z),
                    et = function(t) {
                        tt({
                    ...
                    at = function(t) {
                        ...
                        (e = n.customMedia[t.getAttribute("data-media") || t.getAttribute("media")]) && t.setAttribute("media", e), a && t.setAttribute("srcset", a)
                    },
                    it = _(function(t, e, a, i, r) {
                        var s, o, d, u, f, y;
                        (f = b(t, "lazybeforeunveil", e)).defaultPrevented || (i && (a ? v(t, n.autosizesClass) : t.setAttribute("sizes", i)), o = t.getAttribute(n.srcsetAttr), s = t.getAttribute(n.srcAttr), r && (d = t.parentNode, u = d && c.test(d.nodeName || "")), y = e.firesLoad || "src" in t && (o || s || u), f = {
                            target: t
                        }, v(t, n.loadingClass), y && (clearTimeout(g), g = l(U, 2500), h(t, et, !0)), u && m.call(d.getElementsByTagName("source"), at), o ? t.setAttribute("srcset", o) : s && !u && (P.test(t.nodeName) ? function(t, e) {
                            ...
                            src: s
                        })), t._lazyRace && delete t._lazyRace, z(t, n.lazyClass), E(function() {
                            var e = t.complete && t.naturalWidth > 1;
                            y && !e || (e && v(t, n.fastLoadedClass), Z(f), t._lazyCache = !0, l(function() {
                    ...
                    nt = function(t) {
                        if (!t._lazyRace) {
                            var e, a = O.test(t.nodeName),
                                i = a && (t.getAttribute(n.sizesAttr) || t.getAttribute("sizes")),
                                r = "auto" == i;
                            (!r && f || !a || !t.getAttribute("src") && !t.srcset || t.complete || y(t, n.errorClass) || !y(t, n.lazyClass)) && (e = b(t, "lazyunveilread").detail, r && M.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, V++, it(t, e, r, i, a))
                        }
                    },
                    rt = w(function() {
                        n.loadMode = 3, Y()
                    ...
                    ot = function() {
                        f || (a.now() - L < 999 ? l(ot, 999) : (f = !0, n.loadMode = 3, Y(), o("scroll", st, !0)))
                    };
                return {
                    _: function() {
                        L = a.now(), i.elements = e.getElementsByClassName(n.lazyClass), s = e.getElementsByClassName(n.lazyClass + " " + n.preloadClass), o("scroll", Y, !0), o("resize", Y, !0), o("pageshow", function(t) {
                            if (t.persisted) {
                        ...
                        }), /d$|^c/.test(e.readyState) ? ot() : (o("load", ot), e.addEventListener("DOMContentLoaded", Y), l(ot, 2e4)), i.elements.length ? (X(), E._lsFlush()) : Y()
                    },
                    checkElems: Y,
                    unveil: nt,
                    _aLSL: st
            ...
            M = (W = _(function(t, e, a, i) {
                ...
                if (t._lazysizesWidth = i, i += "px", t.setAttribute("sizes", i), c.test(e.nodeName || ""))
                    for (n = e.getElementsByTagName("source"), r = 0, s = n.length; r < s; r++) n[r].setAttribute("sizes", i);
                a.detail.dataAttr || p(t, a.detail)
            }), B = function(t, e, a) {
                var i, n = t.parentNode;
                n && (a = C(t, n, a), (i = b(t, "lazybeforesizes", {
                    width: a,
                    dataAttr: !!e
                ...
                _: function() {
                    x = e.getElementsByClassName(n.autosizesClass), o("resize", S)
                },
                checkElems: S,
                updateElem: B
            }),
            N = function() {
                !N.i && e.getElementsByClassName && (N.i = !0, M._(), L._())
            };
        var x, W, B, S;
        var T, k, F, R, D, j, q;
        return l(function() {
...
const lazyBg = function(t) {
    ...
    Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_medium + "px)") && (e = a), Modernizr.mq("only screen and (max-width: " + fusionJSVars.visibility_small + "px)") && (e = i), n && e ? t.style.backgroundImage = n + ",url(" + e + ")" : e && (t.style.backgroundImage = "url(" + e + ")")
};
document.addEventListener("lazybeforeunveil", function(t) {
    ...
    e.hasClass("awb-imageframe-style-dario") && (e.css("display", "block"), t.detail.width = t.target.offsetWidth > 40 ? t.target.offsetWidth : e[0].offsetWidth, e.css("display", ""))
});
jQuery(document).ready(function() {
...
function avadaAddQuantityBoxes(t, a) {
    ...
    t || (t = ".qty"), a || (a = jQuery("div.quantity:not(.buttons_added), td.quantity:not(.buttons_added)").find(t)), a.length && (jQuery.each(a, function(t, a) {
        ...
        var a = jQuery(this).parent().find(t),
            ...
            u = a.attr("step");
        e && "" !== e && "NaN" !== e || (e = 0), "" !== i && "NaN" !== i || (i = ""), "" !== o && "NaN" !== o || (o = 0), "any" !== u && "" !== u && void 0 !== u && "NaN" !== parseFloat(u) || (u = 1), jQuery(this).is(".plus") ? i && (i == e || e > i) ? a.val(i) : a.val(e + parseFloat(u)) : o && (o == e || e < o) ? a.val(o) : 0 < e && a.val(e - parseFloat(u)), n && (jQuery(this).closest("tr").hasClass("opc_cart_item") || jQuery(this).closest(".shop_table").parent().hasClass("wcopc")) ? a.trigger("input") : a.trigger("change")
    })))
}
...
var avadaLiveSearch = function() {
    ...
    avadaLiveSearchVars.live_search && jQuery(".fusion-live-search-input").each(function() {
        var e, a = jQuery(this),
            ...
            n = i.find(".fusion-search-submit"),
            o = i.find(".fusion-search-results"),
            r = i.find('input[name^="post_type"]'),
            d = i.find('input[name="search_limit_to_post_titles"]'),
            l = i.find('input[name="live_min_character"]'),
            u = i.find('input[name="live_posts_per_page"]'),
            c = i.find('input[name="live_search_display_featured_image"]'),
            v = i.find('input[name="live_search_display_post_type"]'),
            f = i.find('input[name="live_results_scrollbar"]'),
            h = o.closest(".fusion-builder-row"),
        ...
        function C(s) {
            var e = "";
            o.html(""), o.removeClass("suggestions-empty"), o.addClass("suggestions-added"), S("add"), jQuery.isEmptyObject(s) ? (o.addClass("suggestions-empty"), e += '<div class="fusion-search-result">' + avadaLiveSearchVars.no_search_results + "</div>", o.append(e)) : jQuery.each(s, function(s, a) {
                e = "", e += '<a class="fusion-search-result" href="' + a.post_url + '" title="' + a.title + '">', a.image_url && (e += '<div class="fusion-search-image"><img class="fusion-search-image-tag" src="' + a.image_url + '" alt="Post Thumb' + a.id + '"/></div>'), e += '<div class="fusion-search-content">', e += '<div class="fusion-search-post-title">' + a.title + "</div>", a.type && (e += '<div class="fusion-search-post-type">' + a.type + "</div>"), e += "</div>", e += "</a>", o.append(e)
            })
        }
        ...
        function j() {
            ...
            if (i = a.closest(".fusion-live-search"), e = a.val(), e += (t = function() {
                ...
                })().toString(), g <= a.val().length) {
                if (void 0 !== s[e]) return void C(s[e]);
                i.find(".fusion-slider-loading").show(), i.find(".fusion-search-submit").css("color", "transparent"), n.css("color", "transparent"), jQuery.ajax({
                    ...
                    s[e] = a, C(a), i.find(".fusion-slider-loading").hide(), n.css("color", n.attr("data-color"))
                })
            } else i.find(".fusion-slider-loading").hide(), n.css("color", n.attr("data-color")), o.removeClass("suggestions-added"), S("remove")
        }

        function S(s) {
            h.length && ("add" === s ? h.css("z-index", "11") : h.css("z-index", "")), p.length && ("add" === s ? p.addClass("live-suggestion-added") : p.removeClass("live-suggestion-added"))
        }
        n.attr("data-color", n.css("color")), void 0 !== f.val() && f.val() && o.addClass("live-results-scrollbar-" + f.val()), a.on("focusin", function() {
            g <= jQuery(this).val().length && o.children(".fusion-search-result").length && (o.addClass("suggestions-added"), S("add"))
        }), a.on("focusout", function() {
            o.is(":hover") || t.is(":hover") || (o.removeClass("suggestions-added"), S("remove"), o.addClass("suggestions-transition"), setTimeout(function() {
                o.removeClass("suggestions-transition")
            }, 300))
        }), jQuery(t, o).on("mouseleave", function() {
            a.is(":focus") || (o.removeClass("suggestions-added"), S("remove"), o.addClass("suggestions-transition"), setTimeout(function() {
                o.removeClass("suggestions-transition")
            }, 300))
        }), a.on("keyup", function() {
            clearTimeout(e), e = setTimeout(j, 500)
...
! function(e) {
    "use strict";
    window.awb_oc_timeouts = {}, window.awbOffCanvas = {
        timeouts: {},
        ...
        set: function(e, a, n) {
            ...
            (t = t ? JSON.parse(t) : {})[a] = n, localStorage.setItem("off_canvas" + e, JSON.stringify(t))
        },
        get: function(e, a) {
            e = e ? "_" + e : "_data";
        ...
        open_off_canvas: function(a, n = !0, t = !1) {
            const o = e('.awb-off-canvas-wrap[data-id="' + a + '"]'),
                ...
                c = this;
            if (!o.length) return;
            if (o.hasClass("awb-show") && t) return void this.close_off_canvas(a);
            if (this.set(a, "last_open_date", new Date), o.hasClass("awb-show") && !t) return;
            ...
            if (("off" === i.status_css_animations || "desktop" === i.status_css_animations && i.is_mobile) && (f = !1), f) {
                if (this.animationsWithoutDirection.includes(f) || (f = f + "In" + r), s.addClass("fusion-animated " + f), s.attr("data-animation-type", f), s.css({
                        visibility: "visible",
                    ...
                    e("body").hasClass("rtl") ? (a.marginInlineStart = "-" + s.outerWidth() + "px", "right" === i.position && (a.marginInlineStart = s.outerWidth() + "px")) : (a.marginInlineStart = s.outerWidth() + "px", "right" === i.position && (a.marginInlineStart = "-" + s.outerWidth() + "px"));
                    let n = "#wrapper";
                    o.hasClass("init-for-studio") && (n = ".post-preview"), e(n).css(a), e('#sliders-container .tfs-slider[data-parallax="1"]').length && e('#sliders-container .tfs-slider[data-parallax="1"]').css(a)
                }
            } else this.enableTrapFocus(o);
            if ("yes" === i.overlay && "no" === i.overlay_page_scrollbar && e("html").css("overflow", "hidden"), o.addClass("awb-show"), e('a[href^="#awb-oc__' + a + '"]').addClass("awb-oc-active"), n) {
        ...
        close_off_canvas: function(a, n = !0) {
            ...
            if (("off" === s.status_css_animations || "desktop" === s.status_css_animations && s.is_mobile) && (i = !1), i) {
                if (this.animationsWithoutDirection.includes(i) || (i = i + "Out" + c), o.addClass("fusion-animated " + i), o.attr("data-animation-type", i), o.addClass("is-closing"), o.css("animation-duration", f + "s"), "sliding-bar" === s.type && "push" === s.transition && ("left" === s.position || "right" === s.position)) {
                    const a = {
                        transition: "margin-inline-start " + s.exit_animation_speed + "s",
                        marginInlineStart: 0
                    };
                    let n = "#wrapper";
                    t.hasClass("init-for-studio") && (n = ".post-preview"), e(n).css(a), e('#sliders-container .tfs-slider[data-parallax="1"]').length && e('#sliders-container .tfs-slider[data-parallax="1"]').css(a)
                }
            } else "yes" === s.overlay && t.hasClass("init-for-studio") && o.addClass("is-closing"), "no" === s.overlay && t.hasClass("init-for-studio") && e("#icon-bar .go-back").click(), t.removeClass("awb-show");
            if (e('a[href^="#awb-oc__' + a + '"]').removeClass("awb-oc-active"), "yes" === s.overlay && "no" === s.overlay_page_scrollbar && e("html").css("overflow", ""), setTimeout(() => {
                    this.removeHash()
                }, 10), n) {
                const e = this.get(a, "close_count") || 0;
                this.set(a, "close_count", e + 1)
            }
            this.set(a, "closed", !0), clearTimeout(window.awb_oc_timeouts["close_after_time_" + a]), clearTimeout(window.awb_oc_timeouts["show_close_button_" + a]), parseInt(s.show_close_button_after_time) && o.children(".off-canvas-close").addClass("hidden"), t.trigger(e.Event("awb-oc-closed"), [a])
        },
        removeHash() {
        ...
        enableTrapFocus(e) {
            if (!e.hasClass("type-popup")) return;
            ...
            setTimeout(() => {
                a[0].focus()
            }, 100), a[0].addEventListener("keydown", function(e) {
                ("Tab" === e.key || 9 === e.keyCode) && (e.shiftKey ? document.activeElement === t && (o.focus(), e.preventDefault()) : document.activeElement === o && (t.focus(), e.preventDefault()))
            })
        }
    }, e(".awb-off-canvas").on("animationend", function(a) {
        const n = e(this),
            t = n.parent();
        n.attr("data-animation-type") && n.removeClass("fusion-animated").removeClass(n.attr("data-animation-type")).removeAttr("data-animation-type"), n.hasClass("is-closing") ? (n.removeClass("is-closing"), n.addClass("oc-waiting-for-close"), t.removeClass("awb-show"), t.hasClass("init-for-studio") && e("#icon-bar .go-back").click()) : window.awbOffCanvas.enableTrapFocus(t)
    }), e(".awb-off-canvas-wrap").on("transitionend", function(a) {
        const n = e(this).find(".awb-off-canvas");
        n.hasClass("is-closing") && e(this).hasClass("init-for-studio") && (e("#icon-bar .go-back").click(), n.removeClass("is-closing")), n.removeClass("oc-waiting-for-close")
        ...
        const t = e(n).data("id"),
            ...
            s = e("#wpadminbar"),
            i = s.outerHeight();
        if ("full" === o.height && s.length && e(n).find(".awb-off-canvas").css("height", `calc(100vh - ${i}px)`), "sliding-bar" === o.type && "top" === o.position && s.length && e(n).find(".awb-off-canvas").css("margin-top", `${i}px`), "yes" === o.on_click) {
            const a = o.on_click_element ? e(o.on_click_element) : null;
            a && a.length && (a.attr("data-off-canvas", o.on_click_element), e(document).on("click", o.on_click_element, function(e) {
                e.preventDefault(), window.awbOffCanvas.open_off_canvas(t, !1)
            }))
        }
        ...
        if (o.frequency) {
            ...
            if ("month" === o.frequency && e) {
                e = new Date(e), a < new Date(e).setMonth(e.getMonth() + 1) && (c = !0)
            }
        ...
        if ("yes" === o.after_x_page_views) {
            ...
            e < parseInt(o.number_of_page_views) && (c = !0), window.awbOffCanvas.set(t, "page_views", e + 1)
        }
        if ("yes" === o.after_x_sessions) {
            let e;
            sessionStorage.getItem("off_canvas_" + t) || (sessionStorage.setItem("off_canvas_" + t, !0), e = window.awbOffCanvas.get(t, "sessions") || 0, window.awbOffCanvas.set(t, "sessions", e + 1)), (e = window.awbOffCanvas.get(t, "sessions")) <= parseInt(o.number_of_sessions) && (c = !0)
        }
        if (o.when_arriving_from) {
            ...
            let t;
            !e || e.includes(a) ? t = "internal" : (t = "external", /\.?(google|bing|yahoo|duckduckbot|yandex|baidu|msn|teoma|slurp)\./.test(e) && (t = "search")), c = !n.includes(t)
        }
        if ("opened" === o.off_canvas_state && "sliding-bar" === o.type && o.has_js_rules && !c && (e(window).on("load", function() {
                window.awbOffCanvas.open_off_canvas(t)
            }), c = !0), !0 === o.isOpened && (c = !0), !c) {
            if ("yes" === o.on_page_load && setTimeout(() => {
                    window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0
                }, 100), "yes" === o.time_on_page && o.time_on_page_duration && setTimeout(() => {
                    window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0
                }, 1e3 * o.time_on_page_duration), "yes" === o.on_scroll) {
                const a = o.scroll_direction,
                    n = o.scroll_to,
                    s = document.documentElement.scrollHeight;
                let i = o.scroll_position;
                if (i && isNaN(i) && (i = i.includes("%") ? s / 100 * parseInt(i) : parseInt(i)), "down" === a && "element" === n) {
                    const e = o.scroll_element ? document.querySelector(o.scroll_element) : null;
                    if (e) {
                        const a = new IntersectionObserver(e => {
                            e.forEach(e => {
                                e.isIntersecting && (window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0, a.unobserve(e.target))
                            })
                        });
                        a.observe(e)
                    }
                } else e(window).on("scroll", function(e) {
                    "up" === o.scroll_direction && this.oldScroll > this.scrollY && (o.isOpened || window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0), "down" === o.scroll_direction && this.oldScroll < this.scrollY && this.scrollY >= i && (o.isOpened || window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0), this.oldScroll = this.scrollY
                })
            }
            if ("yes" === o.exit_intent) {
                const e = function(a) {
                    null == a.relatedTarget && "select" !== a.target.nodeName.toLowerCase() && (window.awbOffCanvas.open_off_canvas(t), document.removeEventListener("mouseout", e), o.isOpened = !0)
                };
            ...
            if ("yes" === o.after_inactivity && o.inactivity_duration) {
                ...
                const n = function() {
                    ...
                    s = function() {
                        o.isOpened || window.awbOffCanvas.open_off_canvas(t), o.isOpened = !0
                    },
                    i = function() {
                        document.addEventListener("mousemove", c, !1), document.addEventListener("mousedown", c, !1), document.addEventListener("keypress", c, !1), document.addEventListener("touchmove", c, !1), document.addEventListener("scroll", c, !1), n()
                    },
                    c = function() {
...
jQuery(window).on("load", function() {
    ...
    window.fusionVimeoPlayers = [], jQuery().flexslider && (Number(fusionFlexSliderVars.status_vimeo) && jQuery(".flexslider").find("iframe").each(function() {
        ...
        i && -1 !== s.indexOf("vimeo") && (window.fusionVimeoPlayers[i] = new Vimeo.Player(i), e = jQuery("#" + i).parents("li"), window.fusionVimeoPlayers[i].on("play", function() {
            ...
            jQuery(e).attr("data-vimeo-paused", "true"), "yes" === jQuery(e).attr("data-loop") ? jQuery("#" + i).parents("li").parent().parent().flexslider("pause") : jQuery("#" + i).parents("li").parent().parent().flexslider("play")
        }), window.fusionVimeoPlayers[i].on("ended", function() {
            "yes" !== jQuery(e).attr("data-loop") && "true" !== jQuery(e).attr("data-vimeo-paused") && jQuery("#" + i).parents("li").parent().parent().flexslider("next"), "true" === jQuery(e).attr("data-vimeo-paused", "true") && jQuery(e).attr("data-vimeo-paused", "false")
        }))
...
! function(t) {
    ...
    t.fn.awbAnimateTitleHighlightsAndRotations = function() {
        "IntersectionObserver" in window ? t.each(fusion.getObserverSegmentation(t(this)), function(i) {
            ...
            var i = t(this);
            t(i).hasClass("fusion-title-rotating") && t(i).animateTitleRotations(), t(i).hasClass("fusion-title-highlight") && t(i).animateTitleHighlights()
        })
...
function initSwiperScrollingSection(e) {
    ...
    const t = {
        ...
        on: {
            afterInit: function(t) {
                if (e.find(".fusion-scroll-section-nav ul li:first-child a").addClass("active"), e.addClass("swiper-ready"), window.location.hash.length && e.find(window.location.hash).length) {
                    ...
                    i.length && setTimeout(() => {
                        t.slideTo(i.index(), 0), e[0].scrollIntoView()
                    }, 100)
                }
            },
            activeIndexChange: function(t) {
                e.find(".fusion-scroll-section-nav ul li a").removeClass("active"), e.find(".fusion-scroll-section-nav ul li").eq(t.activeIndex).find("a").addClass("active"), setTimeout(() => {
                    n()
                }, 100)
            },
    ...
    function n(t) {
        ...
        if (t.length && t.hasClass("awb-menu__main-a")) {
            t.parents(".awb-menu__main-ul").find("li.menu-item.current-menu-item").removeClass("current-menu-item"), t.closest(".menu-item").addClass("current-menu-item")
        } else t.addClass("awb-active")
    }
    e.find(".fusion-scroll-section-nav ul li a").on("click", function(e) {
        e.preventDefault();
        const t = jQuery(this).parent().index();
        i.slideTo(t)
    }), 0 == fusionContainerVars.container_hundred_percent_height_mobile && Modernizr.mq("only screen and (max-width: " + fusionContainerVars.content_break_point + "px)") && (e.removeClass("awb-swiper").addClass("fusion-full-scroll-disabled"), i.destroy()), jQuery('a[href^="#"]').on("click", function(t) {
        const o = jQuery(this),
            s = o.attr("href"),
            c = "#" !== s ? e.find(s) : "";
        if (c.length) {
            t.preventDefault();
            let e = c.index();
            c.hasClass("fusion-container-anchor") && (e = c.parent().index()), n(o), i.slideTo(e)
        }
    })
}
...
function initScrollingSections(e) {
    ...
    e && (n = jQuery(".post-preview.post-content").find(".fusion-scroll-section")), n.hasClass("awb-swiper-full-sections") ? initSwiperScrollingSection(n) : (window.lastYPosition = 0, window.scrollDisabled = !1, n.length && (jQuery("#content").find(".non-hundred-percent-height-scrolling").length || 1 !== n.length || jQuery.trim(jQuery("#sliders-container").html()) || (n.addClass("active"), n.find(".fusion-scroll-section-nav li:first a").addClass("active"), t = !0), n.each(function() {
        1 < jQuery(this).children("div").length && (i = o ? "calc(" + (100 * jQuery(this).children("div").length + 50) + "vh - " + o + "px)" : 100 * jQuery(this).children("div").length + 50 + "vh", jQuery(this).css("height", i), o && (jQuery(this).find(".hundred-percent-height-scrolling").css("height", "calc(100vh - " + o + "px)"), jQuery(this).find(".fusion-scroll-section-nav").css("top", "calc(50% + " + o / 2 + "px)")))
        ...
        var t = jQuery(this).parents(".fusion-scroll-section"),
            ...
            l = Math.abs(r - c);
        e.preventDefault(), 0 < l && (t.data("clicked", r), "fixed" !== n.last().css("position") && n.css({
            position: "fixed",
...
jQuery(window).on("load fusion-element-render-fusion_builder_container resize", function(e, t) {
        ...
        var e;
        initScrollingSections(), fusionInitStickyContainers(), !jQuery("body").hasClass("fusion-builder-live") && "object" == typeof cssua && "string" == typeof cssua.ua.safari && 16 > parseInt(cssua.ua.safari) && (e = jQuery(".awb-sticky, .mobile-sticky-tabs, .sticky-tabs")).length && (jQuery("#boxed-wrapper").addClass("safari-overflow"), e.each(function() {
            ...
            jQuery(this).parent().css("--awb-background-image", e), jQuery(this).parent().css("--awb-background-color", t), jQuery(this).remove()
        })
    }), jQuery(window).on("load", function() {
    ...
    a.fn.fusion_footer_parallax = function() {
        ...
        t.length && setTimeout(function() {
            ...
            a("body").hasClass("layout-boxed-mode") && !a("body").hasClass("fusion-top-header") && (r = a("body").offset().top, n = a("body").outerHeight(!0) - a("body").outerHeight() - r), t.outerHeight() + n < a(window).height() && h > a(window).height() && ("top" === avadaParallaxFooterVars.header_position || "top" !== avadaParallaxFooterVars.header_position && a(window).height() > a(".side-header-wrapper").height()) && Modernizr.mq("only screen and (min-width:" + parseInt(avadaParallaxFooterVars.side_header_break_point, 10) + "px)") && !Modernizr.mq("only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: portrait)") && !Modernizr.mq("only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: landscape)") ? (s = a("body").hasClass("layout-boxed-mode") ? {
                ...
                "margin-bottom": "",
                "min-height": ""
            }), t.removeClass("awb-footer-fixed"))
        }, 200)
    }
}(jQuery), jQuery(window).on("load", function() {
    jQuery(".fusion-footer-parallax").fusion_footer_parallax(), jQuery(window).on("fusion-resize-vertical fusion-parallax-footer-refresh", function() {
...
jQuery(document).ready(function() {
    ...
    function n() {
        jQuery.fn.fusion_position_menu_dropdown && (jQuery(".fusion-dropdown-menu, .fusion-dropdown-menu li").on("mouseenter", function() {
            jQuery(this).closest(".awb-menu").length || jQuery(this).fusion_position_menu_dropdown()
    ...
    function u() {
        jQuery(".fusion-mobile-nav-holder").not(".fusion-mobile-sticky-nav-holder").each(function() {
            ...
            "#" === jQuery(this).attr("href") && ("modal" === jQuery(this).data("toggle") ? jQuery(this).trigger("show.bs.modal") : void 0 === jQuery(this).parent().data("off-canvas") && (e.preventDefault(), e.stopPropagation()), jQuery(this).next(".fusion-open-submenu").trigger("click"))
        }))
    }
...
function fusionGetScrollOffset() {
    var t, o = fusion.getAdminbarHeight(),
        e = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0,
        s = parseInt(o + e + 1, 10);
...
! function(t) {
    ...
    s.VERSION = "3.3.2", s.DEFAULTS = {
        ...
        l.parent(".sub-menu").length && (l = l.closest("li.fusion-dropdown-menu").addClass(e)), l.trigger("activate.bs.scrollspy"), l && t(this.selector).blur()
    }, s.prototype.clear = function() {
        var s = this.options.currentItemClass ? this.options.currentItemClass : "current-menu-item";
        t(this.selector).parentsUntil(this.options.target, "." + s).removeClass(s), t(this.selector).parentsUntil(this.options.target, ".current-menu-parent").removeClass("current-menu-parent")
...
! function(e) {
    ...
    e.fn.fusion_scroll_to_anchor_target = function(t) {
        var n, o, s, i, a, l, r, c, u, f, h, d, p = void 0 !== e(this).attr("href") ? e(this).attr("href") : e(this).data("link"),
            g = p.substr(p.indexOf("#")).slice(1),
            m = e("#" + g),
            y = e("html").hasClass("ua-edge") || e("html").hasClass("ua-safari-12") || e("html").hasClass("ua-safari-11") || e("html").hasClass("ua-safari-10") ? "body" : "html",
            b = e(".fusion-tb-header").length,
            w = !1,
            _ = !1;
        if (t = void 0 !== t ? t : 0, m.length && "" !== g) {
            if (m.parents(".fusion-scroll-section").hasClass("awb-swiper-full-sections")) return;
            if ((m.parents(".hundred-percent-height-scrolling").length || m.find(".hundred-percent-height-scrolling").length) && (0 != fusionScrollToAnchorVars.container_hundred_percent_height_mobile || !Modernizr.mq("only screen and (max-width: " + fusionScrollToAnchorVars.content_break_point + "px)"))) {
                if ((d = m.hasClass("fusion-scroll-section-element") ? m : m.parents(".fusion-scroll-section-element")).hasClass("active") && d.offset().top >= e(window).scrollTop() && d.offset().top < e(window).scrollTop() + e(window).height()) return !1;
                if (location.hash && "#_" === location.hash.substring(0, 2) && e(".fusion-page-load-link").addClass("fusion-page.load-scroll-section-link"), m.parents(".fusion-scroll-section").length) return m.parents(".fusion-scroll-section").hasClass("active") ? m.parents(".fusion-scroll-section").find(".fusion-scroll-section-nav").find(".fusion-scroll-section-link[data-element=" + d.data("element") + "]").trigger("click") : (h = Math.ceil(m.parents(".fusion-scroll-section").offset().top), e(y).animate({
                    scrollTop: h
                }, {
                    duration: 400,
                    easing: "easeInExpo",
                    complete: function() {
                        setTimeout(function() {
                            m.parents(".fusion-scroll-section").find(".fusion-scroll-section-nav").find(".fusion-scroll-section-link[data-element=" + d.data("element") + "]").trigger("click"), location.hash && "#_" === location.hash.substring(0, 2) && ("history" in window && "replaceState" in history && history.replaceState("", window.location.href.replace("#_", "#"), window.location.href.replace("#_", "#")), e(".fusion-page-load-link").removeClass("fusion-page.load-scroll-section-link"))
                        }, parseInt(fusionScrollToAnchorVars.hundred_percent_scroll_sensitivity) + 50)
                    }
                })), !1
            }
            return m.parents(".awb-off-canvas").length ? 0 !== m.parents(".awb-off-canvas-wrap.awb-show").length && (r = (l = m.parents(".awb-off-canvas-wrap.awb-show").find(".off-canvas-content"))[0].getBoundingClientRect().top, c = m[0].getBoundingClientRect().top, u = l.scrollTop(), i = c < r ? u - (r - c) : Math.abs(u + (c - r)), f = l[0].scrollHeight - l.outerHeight(), i > f && (i = f), void l.animate({
                scrollTop: i
            }, {
                duration: 400
            })) : (n = fusion.getAdminbarHeight(), s = e(document).scrollTop(), b ? (e("body").addClass("fusion-scrolling-active"), (w = fusionGetStickyOffset()) || (w = n), i = m.offset().top - w - t) : (o = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, i = m.offset().top - n - o - t), a = Math.abs(s - i) / 2, h = s > i ? s - a : s + a, e(y).animate({
                scrollTop: h
            }, {
                duration: 400,
                easing: "easeInExpo",
                complete: function() {
                    n = fusion.getAdminbarHeight(), b ? ((w = fusionGetStickyOffset()) || (w = n), i = Math.ceil(m.offset().top) - w - t) : (o = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, i = Math.ceil(m.offset().top) - n - o - t), e(y).animate({
                        scrollTop: i
                    }, 450, "easeOutExpo", function() {
                        location.hash && "#_" === location.hash.substring(0, 2) && "history" in window && "replaceState" in history && history.replaceState("", window.location.href.replace("#_", "#"), window.location.href.replace("#_", "#")), b && ((_ = fusionGetStickyOffset()) || (_ = n), w !== _ && (i = Math.ceil(m.offset().top) - _ - t, e(y).animate({
                            scrollTop: i
                        }, 450)), e("body").removeClass("fusion-scrolling-active"))
                    })
                }
            }), (m.hasClass("tab-pane") || m.hasClass("tab-link")) && "function" == typeof e.fn.fusionSwitchTabOnLinkClick && setTimeout(function() {
                m.parents(".fusion-tabs").fusionSwitchTabOnLinkClick()
            }, 100), !1)
        }
    }
}(jQuery), jQuery(document).ready(function() {
    jQuery("body").on("click", '.fusion-menu a:not([href="#"], .fusion-megamenu-widgets-container a, .search-link), .fusion-widget-menu a, .fusion-secondary-menu a, .fusion-mobile-nav-item a:not([href="#"], .search-link), .fusion-button:not([href="#"], input, button), .fusion-one-page-text-link:not([href="#"]), .fusion-content-boxes .fusion-read-more:not([href="#"]), .fusion-imageframe > .fusion-no-lightbox, .content-box-wrapper:not(.link-area-box) .heading-link, a.woocommerce-review-link, .awb-toc-el .awb-toc-el__item-anchor', function(e) {
        var t, n, o, s, i, a, l, r, c = jQuery("body").hasClass("fusion-builder-live");
        ...
        if (this.hash) {
            if (l = jQuery(this).attr("target") ? jQuery(this).attr("target") : "_self", s = (o = void 0 !== (n = (t = jQuery(this).attr("href")).split("#"))[1] ? n[1] : "").substring(0, 1), a = (i = n[0]).substring(i.length - 1, i.length), "#hubspot-open-chat" === t) return;
            if (void 0 !== (r = o.split("-"))[0] && "tab" === r[0]) return;
            if ("/" !== a && (i += "/"), "!" === s || "/" === s) return;
